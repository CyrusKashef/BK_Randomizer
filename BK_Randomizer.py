...
### TODO ###
# 1) Remove the username from the log files
# 2) Create a "Save Rom As" to prevent creating an extra rom
# 3) Possible option to remove unkillable enemies from completely randomized
...
default_options = {
    #"Rom": r"C:/Users/<USER>/Desktop/N64/ROMs/GEDecompressor_Files/Banjo-Kazooie.z64",
    "Rom": os.getcwd(),
    "Non-Flag": "2",
    "Flagged": "1",
    "Struct": "2",
...
setup_ids = {
    # Setup Location
        ...
        #           "1F 8B 08 08 E7 6F 67 60 00 0B" is the header needed to decompress every Banjo-Kazooie setup
        #           The next 6 digits are the hex values for the ascii name of the file derived from the index that the setup starts at (example spiral mountain goes from ascii "4C4680" to hex "34 43 34 36 38 30")
        ...
        #         Starts with "11 72 00 00" with two extra hex values
        # Tail -> Compressed file's original footer
        #         Grab the trailing AAs from the rom
    "Spiral Mountain": [
        ("0x9780", # Main Area - 4C4680
            ['1F', '8B', '08', '08', '3E', 'FE', '6B', '60', '00', '0B', '34', '43', '34', '36', '38', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Mumbo's Mountain": [
        ("0x9788", # Main Area - 4C5A30
            ['1F', '8B', '08', '08', '37', 'FC', '6B', '60', '00', '0B', '34', '43', '35', '41', '33', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["07", "D0", "9F", "9C", "10", "39", "00", "00"],
            ["11", "72", "00", "00", "39", "10"],
            []
            ),
        ("0x97D8", # Ticker's Tower - 4CCD40
            ['1F', '8B', '08', '08', '37', 'FC', '6B', '60', '00', '0B', '34', '43', '43', '44', '34', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["09", "CE", "33", "CD", "97", "07", "00", "00"],
            ["11", "72", "00", "00", "07", "97"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x97E8", # Mumbo's Skull - 4CF158
            ['1F', '8B', '08', '08', '37', 'FC', '6B', '60', '00', '0B', '34', '43', '46', '31', '35', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Treasure Trove Cove":[
        ("0x97B0", # Main Area - 4C7FD8
            ['1F', '8B', '08', '08', 'B5', '01', '6B', '60', '00', '0B', '34', '43', '37', '46', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["F8", "F9", "1A", "71", "A6", "54", "00", "00"],
            ["11", "72", "00", "00", "54", "A6"],
            ["AA", "AA", "AA"]
            ),
        ("0x97A0", # Blubber's Ship - 4C7918
            ['1F', '8B', '08', '08', 'B5', '01', '6B', '60', '00', '0B', '34', '43', '37', '39', '31', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["3A", "BE", "F3", "F9", "28", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "28"],
            ["AA"]
            ),
        ("0x97A8", # Nipper's Shell - 4C7C38
            ['1F', '8B', '08', '08', 'B5', '01', '6B', '60', '00', '0B', '34', '43', '37', '43', '33', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["82", "74", "6F", "6D", "1D", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "1D"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x97C8", # Sandcastle - 4CAD60
            ['1F', '8B', '08', '08', 'B5', '01', '6B', '60', '00', '0B', '34', '43', '41', '44', '36', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Clanker's Cavern": [
        ("0x97D0", # Main Area - 4CB028
            ['1F', '8B', '08', '08', '45', '6A', '6B', '60', '00', '0B', '34', '43', '42', '30', '32', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["BE", "C8", "0F", "88", "08", "3B", "00", "00"],
            ["11", "72", "00", "00", "3B", "08"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9888", # Inside Clanker Mouth And Belly - 4D95E0
            ['1F', '8B', '08', '08', '45', '6A', '6B', '60', '00', '0B', '34', '44', '39', '35', '45', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["FF", "51", "5D", "EA", "D3", "16", "00", "00"],
            ["11", "72", "00", "00", "16", "D3"],
            ["AA"]
            ),
        ("0x9880", # Inside Clanker Blowhole Entrance - 4D91C8
            ['1F', '8B', '08', '08', '45', '6A', '6B', '60', '00', '0B', '34', '44', '39', '31', '43', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["7A", "D4", "1E", "70", "CA", "07", "00", "00"],
            ["11", "72", "00", "00", "07", "CA"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9890", # Inside Clanker Gold Feather Room - 4DA1B8
            ['1F', '8B', '08', '08', '45', '6A', '6B', '60', '00', '0B', '34', '44', '41', '31', '42', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Bubblegloop Swamp": [
        ("0x97E0", # Main Area - 4CD1E8
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '43', '44', '31', '45', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["E1", "B8", "9D", "0B", "7B", "3B", "00", "00"],
            ["11", "72", "00", "00", "3B", "7B"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x97F8", # Mr Vile - 4CF410
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '43', '46', '34', '31', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["AB", "24", "EE", "F7", "FB", "09", "00", "00"],
            ["11", "72", "00", "00", "09", "FB"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9800", # TipTup Choir - 4CF990
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '43', '46', '39', '39', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["3E", "00", "7C", "A7", "35", "07", "00", "00"],
            ["11", "72", "00", "00", "07", "35"],
            ["AA", "AA"]
            ),
        ("0x99B0", # Mumbo's Skull - 4E9F00
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '39', '46', '30', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Freezeezy Peak": [
        ("0x98B0", # Main Area - 4DB118
            ['1F', '8B', '08', '08', '9C', '36', '6B', '60', '00', '0B', '34', '44', '42', '31', '31', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["A4", "F1", "32", "D8", "14", "5E", "00", "00"],
            ["11", "72", "00", "00", "5E", "14"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9980", # Boggy's Igloo - 4E4820
            ['1F', '8B', '08', '08', '9C', '36', '6B', '60', '00', '0B', '34', '45', '34', '38', '32', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["68", "7A", "BA", "AD", "E0", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "E0"],
            ["AA", "AA", "AA"]
            ),
        ("0x99B8", # Mumbo's Skull - 4EA168
            ['1F', '8B', '08', '08', '9C', '36', '6B', '60', '00', '0B', '34', '45', '41', '31', '36', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["83", "67", "E8", "E6", "97", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "97"],
            []
            ),
        ("0x9A10", # Inside The Tree - 4EACA8
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '41', '43', '41', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["61", "23", "35", "7A", "6C", "0B", "00", "00"],
            ["11", "72", "00", "00", "0B", "6C"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9B70", # Wozza's Cave - 4F6088
            ['1F', '8B', '08', '08', '9C', '36', '6B', '60', '00', '0B', '34', '46', '36', '30', '38', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Gobi's Valley": [
        ("0x9808", # Main Area - 4CFDF0
            ['1F', '8B', '08', '08', 'AF', '39', '6B', '60', '00', '0B', '34', '43', '46', '44', '46', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["6C", "9D", "63", "95", "D4", "47", "00", "00"],
            ["11", "72", "00", "00", "47", "D4"],
            []
            ),
        ("0x9810", # Puzzle Room - 4D2450
            ['1F', '8B', '08', '08', 'AF', '39', '6B', '60', '00', '0B', '34', '44', '32', '34', '35', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["C0", "39", "07", "9B", "F0", "04", "00", "00"],
            ["11", "72", "00", "00", "04", "F0"],
            ["AA", "AA", "AA"]
            ),
        ("0x9818", # King Sandybutt's Tomb - 4D2778
            ['1F', '8B', '08', '08', 'AF', '39', '6B', '60', '00', '0B', '34', '44', '32', '37', '37', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["82", "69", "5D", "2F", "35", "19", "00", "00"],
            ["11", "72", "00", "00", "19", "35"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9820", # Water Room - 4D3630
            ['1F', '8B', '08', '08', 'AF', '39', '6B', '60', '00', '0B', '34', '44', '33', '36', '33', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["95", "83", "F2", "B6", "F7", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "F7"],
            ["AA", "AA"]
            ),
        ("0x9828", # Rupee - 4D3A40
            ['1F', '8B', '08', '08', 'AF', '39', '6B', '60', '00', '0B', '34', '44', '33', '41', '34', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["31", "6C", "24", "10", "F1", "07", "00", "00"],
            ["11", "72", "00", "00", "07", "F1"],
            ["AA"]
            ),
        ("0x9848", # Jinxy - 4D3F38
            ['1F', '8B', '08', '08', 'AF', '39', '6B', '60', '00', '0B', '34', '44', '33', '46', '33', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Mad Monster Mansion": [
        ("0x9850", # Main Area - 4D44D8
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '34', '34', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["A9", "19", "C5", "C7", "51", "45", "00", "00"],
            ["11", "72", "00", "00", "45", "51"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9BE0", # Septic Tank (Inside Loggo) - 4FA110
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '46', '41', '31', '31', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["59", "92", "50", "A6", "F9", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "F9"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9858", # Church - 4D6988
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '36', '39', '38', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["5C", "69", "C7", "2D", "A2", "13", "00", "00"],
            ["11", "72", "00", "00", "13", "A2"],
            []
            ),
        ("0x9860", # Cellar - 4D7358
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '37', '33', '35', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["69", "27", "0D", "8A", "9C", "09", "00", "00"],
            ["11", "72", "00", "00", "09", "9C"],
            ["AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9898", # Tumblar's Shed - 4DA480
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '41', '34', '38', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["86", "BA", "A3", "B4", "3C", "08", "00", "00"],
            ["11", "72", "00", "00", "08", "3C"],
            ["AA", "AA", "AA"]
            ),
        ("0x98A0", # Well - 4DA8E0
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '41', '38', '45', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["6D", "6D", "C3", "EC", "12", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "12"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x98A8", # Dining Room - 4DAC80
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '41', '43', '38', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["14", "D7", "09", "DC", "4B", "07", "00", "00"],
            ["11", "72", "00", "00", "07", "4B"],
            []
            ),
        ("0x98B8", # Egg Room - 4DE0E8
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '45', '30', '45', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["1D", "14", "90", "02", "0C", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "0C"],
            ["AA", "AA", "AA"]
            ),
        ("0x98C0", # Note Room - 4DE300
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '45', '33', '30', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["69", "0C", "75", "58", "E0", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "E0"],
            ["AA", "AA", "AA"]
            ),
        ("0x98C8", # Red Feather Room - 4DE4F0
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '45', '34', '46', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["54", "E8", "C1", "C6", "70", "04", "00", "00"],
            ["11", "72", "00", "00", "04", "70"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x98D0", # Secret Church Room - 4DE790
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '45', '37', '39', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["0F", "E7", "C6", "4B", "BD", "04", "00", "00"],
            ["11", "72", "00", "00", "04", "BD"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x98D8", # Bathroom - 4DEA80
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '45', '41', '38', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["CF", "1E", "88", "35", "D6", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "D6"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x98E0", # Bedroom - 4DED00
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '45', '44', '30', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["C3", "51", "F0", "FF", "67", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "67"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x98E8", # Gold Feather Room - 4DF0C0
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '46', '30', '43', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["D8", "CC", "7D", "83", "D1", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "D1"],
            ["AA", "AA"]
            ),
        ("0x98F0", # Drain Pipe - 4DF290
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '46', '32', '39', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["D0", "4E", "C5", "5D", "E1", "01", "00", "00"],
            ["11", "72", "00", "00", "01", "E1"],
            ["AA", "AA"]
            ),
        ("0x98F8", # Mumbo's Skull - 4DF3E0
            ['1F', '8B', '08', '08', '84', '3F', '6B', '60', '00', '0B', '34', '44', '46', '33', '45', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Rusty Bucket Bay": [
        ("0x9900", # Main Area - 4DF660
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '44', '46', '36', '36', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["18", "53", "DC", "59", "E2", "3B", "00", "00"],
            ["11", "72", "00", "00", "3B", "E2"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9BD0", # Anchor Room - 4F9A08
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '46', '39', '41', '30', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["5C", "B3", "37", "8F", "F0", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "F0"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9918", # Machine (Engine) Room - 4E13D8
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '31', '33', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["6A", "CF", "48", "85", "E5", "16", "00", "00"],
            ["11", "72", "00", "00", "16", "E5"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9920", # Big Fish Warehouse - 4E1F50
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '31', '46', '35', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["D9", "FB", "4E", "94", "76", "08", "00", "00"],
            ["11", "72", "00", "00", "08", "76"],
            ["AA"]
            ),
        ("0x9928", # Boat Room - 4E2440
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '32', '34', '34', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["F5", "2C", "9F", "54", "53", "04", "00", "00"],
            ["11", "72", "00", "00", "04", "53"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9930", # First Blue Container (Chompas) - 4E26D8
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '32', '36', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["D7", "4B", "9B", "8C", "0D", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "0D"],
            ["AA"]
            ),
        ("0x9938", # Third Blue Container (Mini Kabooms) - 4E29C8
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '32', '39', '43', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["6C", "5B", "0C", "D9", "E9", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "E9"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9940", # Sea-Grublin's Cabin - 4E2C48
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '32', '43', '34', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["06", "4C", "8D", "44", "88", "04", "00", "00"],
            ["11", "72", "00", "00", "04", "88"],
            ["AA", "AA", "AA"]
            ),
        ("0x9948", # Kaboom's Room - 4E2ED8
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '32', '45', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["6D", "C0", "63", "18", "02", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "02"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9950", # Mini Kaboom's Room (Pipe) - 4E3238
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '33', '32', '33', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["83", "2F", "82", "83", "FA", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "FA"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9958", # Kitchen - 4E35D0
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '33', '35', '44', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["0D", "B9", "58", "EF", "A8", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "A8"],
            ["AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9960", # Navigation Room - 4E3948
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '33', '39', '34', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["74", "13", "AA", "2B", "AA", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "AA"],
            ["AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9968", # Second Blue Container (Sea-Grublins) - 4E3D30
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '33', '44', '33', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["1E", "CB", "BD", "50", "37", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "37"],
            ["AA", "AA"]
            ),
        ("0x9970", # Captain's Room - 4E4060
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '34', '30', '36', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Click Clock Wood - Lobby": [
        ("0x9978", # Main Area - 4E4290
            ['1F', '8B', '08', '08', 'BF', '48', '6B', '60', '00', '0B', '34', '45', '34', '32', '39', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Click Clock Wood - Spring": [
        ("0x9990", # Spring Main Area - 4E4AA8
            ['1F', '8B', '08', '08', '27', 'FC', '6B', '60', '00', '0B', '34', '45', '34', '41', '41', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["32", "27", "4F", "9E", "56", "28", "00", "00"],
            ["11", "72", "00", "00", "28", "56"],
            []
            ),
        ("0x99C8", # Mumbo Skull Spring - 4EA3A8
            ['1F', '8B', '08', '08', '27', 'FC', '6B', '60', '00', '0B', '34', '45', '41', '33', '41', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["A9", "76", "AB", "72", "A7", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "A7"],
            ["AA"]
            ),
        ("0x9A50", # Beehive Spring - 4EB538
            ['1F', '8B', '08', '08', '27', 'FC', '6B', '60', '00', '0B', '34', '45', '42', '35', '33', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["05", "BB", "08", "CA", "7A", "06", "00", "00"],
            ["11", "72", "00", "00", "06", "7A"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9A68", # Nabnut's House Spring - 4EBB50
            ['1F', '8B', '08', '08', '27', 'FC', '6B', '60', '00', '0B', '34', '45', '42', '42', '35', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["BA", "18", "DE", "E4", "A1", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "A1"],
            ["AA"]
            ),
        ("0x9AA0", # Whipcrack Room Spring - 4EC748
            ['1F', '8B', '08', '08', '27', 'FC', '6B', '60', '00', '0B', '34', '45', '43', '37', '34', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Click Clock Wood - Summer": [
        ("0x9998", # Summer Main Area - 4E5B98
            ['1F', '8B', '08', '08', 'D6', '0D', '6B', '60', '00', '0B', '34', '45', '35', '42', '39', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["5E", "1D", "C1", "C7", "80", "32", "00", "00"],
            ["11", "72", "00", "00", "32", "80"],
            ["AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x99D0", # Mumbo Skull Summer - 4EA5E8
            ['1F', '8B', '08', '08', 'D6', '0D', '6B', '60', '00', '0B', '34', '45', '41', '35', '45', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["A4", "FC", "6A", "F1", "40", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "40"],
            ["AA", "AA"]
            ),
        ("0x9A48", # Beehive Summer - 4EB258
            ['1F', '8B', '08', '08', 'D6', '0D', '6B', '60', '00', '0B', '34', '45', '42', '32', '35', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["05", "9F", "AF", "92", "D6", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "D6"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9A70", # Nabnut's House Summer - 4EBD18
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '42', '44', '31', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["4F", "3D", "EE", "65", "9D", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "9D"],
            ["AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9AA8", # Whipcrack Room Summer - 4EC9D8
            ['1F', '8B', '08', '08', 'D6', '0D', '6B', '60', '00', '0B', '34', '45', '43', '39', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Click Clock Wood - Fall": [
        ("0x99A0", # Fall Main Area - 4E73B0
            ['1F', '8B', '08', '08', '31', '11', '6B', '60', '00', '0B', '34', '45', '37', '33', '42', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["A7", "08", "30", "AB", "38", "33", "00", "00"],
            ["11", "72", "00", "00", "33", "38"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x99D8", # Mumbo Skull Fall - 4EA7D8
            ['1F', '8B', '08', '08', '31', '11', '6B', '60', '00', '0B', '34', '45', '41', '37', '44', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["4D", "04", "4B", "FC", "A7", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "A7"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9A58", # Beehive Fall - 4EB880
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '42', '38', '38', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["B9", "40", "F9", "49", "B6", "05", "00", "00"],
            ["11", "72", "00", "00", "05", "B6"],
            ["AA", "AA"]
            ),
        ("0x9A78", # Nabnut's House Fall - 4EBEF0
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '42', '45', '46', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["BF", "7A", "36", "47", "81", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "81"],
            ["AA", "AA"]
            ),
        ("0x9A90", # Nabnut's Attic Fall - 4EC480
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '43', '34', '38', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["95", "62", "EA", "87", "C0", "01", "00", "00"],
            ["11", "72", "00", "00", "01", "C0"],
            ["AA", "AA", "AA", "AA"]
            ),
        ("0x9AB0", # Whipcrack Room Fall - 4ECC50
            ['1F', '8B', '08', '08', '64', '93', '6B', '60', '00', '0B', '34', '45', '43', '43', '35', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
    ...
    "Click Clock Wood - Winter": [
        ("0x99A8", # Winter Main Area - 4E8C88
            ['1F', '8B', '08', '08', '95', '13', '6B', '60', '00', '0B', '34', '45', '38', '43', '38', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["2B", "FA", "EB", "0D", "BB", "29", "00", "00"],
            ["11", "72", "00", "00", "29", "BB"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x99E0", # Mumbo Skull Winter - 4EAA18
            ['1F', '8B', '08', '08', '95', '13', '6B', '60', '00', '0B', '34', '45', '41', '41', '31', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["FF", "F3", "79", "F6", "37", "04", "00", "00"],
            ["11", "72", "00", "00", "04", "37"],
            ["AA", "AA", "AA"]
            ),
        ("0x9A80", # Nabnut's House Winter - 4EC0A8
            ['1F', '8B', '08', '08', '95', '13', '6B', '60', '00', '0B', '34', '45', '43', '30', '41', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["FE", "53", "2E", "B3", "8A", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "8A"],
            ["AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9A88", # Nabnut's Attic Winter 1 (Nuts) - 4EC278
            ['1F', '8B', '08', '08', '95', '13', '6B', '60', '00', '0B', '34', '45', '43', '32', '37', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["ED", "AC", "14", "22", "61", "03", "00", "00"],
            ["11", "72", "00", "00", "03", "61"],
            ["AA"]
            ),
        ("0x9A98", # Nabnut's Attic Winter 2 (Water) - 4EC5A8
            ['1F', '8B', '08', '08', '95', '13', '6B', '60', '00', '0B', '34', '45', '43', '35', '41', '38', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
            ["81", "F5", "6E", "02", "AA", "02", "00", "00"],
            ["11", "72", "00", "00", "02", "AA"],
            ["AA", "AA", "AA", "AA", "AA", "AA", "AA"]
            ),
        ("0x9AB8", # Whipcrack Room Winter - 4ECEA0
            ['1F', '8B', '08', '08', '95', '13', '6B', '60', '00', '0B', '34', '45', '43', '45', '41', '30', '2D', '44', '65', '63', '6F', '6D', '70', '72', '65', '73', '73', '65', '64', '2E', '62', '69', '6E', '00'],
...
def compress_file(file_dir, decompressed_file):
    ...
    cmd = file_dir + "GZIP.EXE -c " + file_dir + tmp_folder + decompressed_file.upper() + "-Decompressed.bin > " + file_dir + tmp_folder + decompressed_file.upper() + "-Compressed.bin"
#     logger.debug(cmd)
    os.system(cmd)
...
def compressor(file_dir, location_setup, decompressed_file):
    ...
    with open(file_dir + tmp_folder + decompressed_file + "-Compressed.bin", "r+b") as comp_file:
...
# dev_decompressor("C:/Users/<USER>/Desktop/N64/ROMs/GEDecompressor_Files/", "Banjo-Kazooie.z64")
# dev_compress_folder("C:/Users/<USER>/Desktop/N64/ROMs/GEDecompressor_Files/")

# print_header("C:/Users/<USER>/Desktop/N64/ROMs/GEDecompressor_Files/", "Banjo-Kazooie.z64")
logger.info("########## Done ##########")
