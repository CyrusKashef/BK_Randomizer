...
from .Speech_File import Speech_File
from ...Dicts_And_Lists.World_Order_Warps import bottles_moves_camera_dict
from ...Common_Functions import read_json

class Speech_Manipulation():
    ...
    def _brentilda_intro(self):
        ...
        brentilda_text = Speech_File(self._file_dir, "E3A0")
    ...
    def _click_clock_wood_item_count(self, world_object_list, object_name):
        if(object_name == "Bottles"):
            ...
            for world_object in world_object_list:
                for setup_file in world_object._setup_list:
                    jiggy_count += setup_file.jiggy_count
    ...
    def _brentilda_1_1(self, world_object):
        ...
        brentilda_text = Speech_File(self._file_dir, "E2B0")
    ...
    def _brentilda_1_2(self, world_object):
        ...
        brentilda_text = Speech_File(self._file_dir, "E2B8")
    ...
    def _brentilda_1_3(self, world_object):
        ...
        brentilda_text = Speech_File(self._file_dir, "E2C0")
        brentilda_text._replace_line("414e4420534845", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_2_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E2C8")
    ...
    def _brentilda_2_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E2D0")
    ...
    def _brentilda_2_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E2D8")
        brentilda_text._replace_line("414e4420544845", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_3_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E388")
    ...
    def _brentilda_3_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E390")
    ...
    def _brentilda_3_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E398")
        brentilda_text._replace_line("4d5920534953544552", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_4_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E340")
    ...
    def _brentilda_4_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E348")
    ...
    def _brentilda_4_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E350")
        brentilda_text._replace_line("534845204f4654454e20424f41535453", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_5_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E2E0")
    ...
    def _brentilda_5_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E2E8")
    ...
    def _brentilda_5_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E2F0")
        brentilda_text._replace_line("594f5520574f4e2754", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_6_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E328")
    ...
    def _brentilda_6_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E330")
    ...
    def _brentilda_6_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E338")
        brentilda_text._replace_line("5748494c452053495050494e47", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_7_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E300")
    ...
    def _brentilda_7_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E308")
        brentilda_text._replace_line("5741525442414753", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_8_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E310")
    ...
    def _brentilda_8_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E318")
        brentilda_text._replace_line("53484520414c534f", f"{(world_object._world_name).upper()} HAS {note_count} NOTES! ~")
    ...
    def _brentilda_8_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E320")
        brentilda_text._replace_line("414e4420594f552744", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_9_1(self, world_object):
        ...
        new_move_count = self._item_count(world_object, "Bottles")
        brentilda_text = Speech_File(self._file_dir, "E370")
    ...
    def _brentilda_9_2(self, world_object):
        ...
        note_count = self._item_count(world_object, "Note")
        brentilda_text = Speech_File(self._file_dir, "E378")
    ...
    def _brentilda_9_3(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E380")
        brentilda_text._replace_line("5348452753205245414c4c59", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_10_1(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E358")
        brentilda_text._replace_line("47525545534f4d45", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    ...
    def _brentilda_10_2(self, world_object):
        ...
        jiggy_count, honeycomb_count = self._item_count(world_object, "Flagged")
        brentilda_text = Speech_File(self._file_dir, "E360")
        brentilda_text._replace_line("5448495320504f4f5220475559", f"{(world_object._world_name).upper()} HAS {jiggy_count} JIGGIES & {honeycomb_count} EMPTY HONEYCOMBS! ~")
    
    def _brentilda_10_3(self):
        '''PyDoc'''
        # 0xE368 - 5CFB68
        # WHEN SHE WAS YOUNGER, GRUNTY USED TO HAVE ~ AS A PET!
        brentilda_text = Speech_File(self._file_dir, "E368")
    ...
    def _intro_cutscene_1(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D150")
    ...
    def _intro_cutscene_2(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D158")
    ...
    def _intro_cutscene_4(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D168")
#         intro_cutscene_text._replace_line("4849205448455245", "")
    ...
    def _intro_cutscene_5(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D170")
    ...
    def _intro_cutscene_6(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D178")
...
#         intro_cutscene_text = Speech_File(self._file_dir, "D180")
...
#         intro_cutscene_text._replace_line("57484552452c204d52", "")
    ...
    def _intro_cutscene_8(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D188")
    ...
    def _intro_cutscene_9(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D190")
    ...
    def _intro_cutscene_10(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D198")
    ...
    def _intro_cutscene_11(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D1A0")
    ...
    def _intro_cutscene_12(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D1A8")
...
#         intro_cutscene_text = Speech_File(self._file_dir, "D1B0")
...
#         intro_cutscene_text = Speech_File(self._file_dir, "")
...
#         intro_cutscene_text._replace_line("", "")
    ...
    def _enter_lair_cutscene(self):
        ...
        # TOOTY: BANJO............HELP!
        intro_cutscene_text = Speech_File(self._file_dir, "D1C8")
    ...
    def _bottles_50_notes(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "DA38")
    ...
    def _bottles_enter_mm_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D9D8")
    ...
    def _bottles_learned_mm_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "B908")
    ...
    def _bottles_enter_ttc_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D9E0")
    ...
    def _bottles_learned_ttc_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "AFD0")
    ...
    def _bottles_enter_cc_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D9E8")
    ...
    def _bottles_learned_cc_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "C850")
    ...
    def _bottles_enter_bgs_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D9F0")
    ...
    def _bottles_learned_bgs_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "C2E8")
    ...
    def _bottles_enter_fp_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "D9F8")
    ...
    def _bottles_learned_fp_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "BFE8")
    ...
    def _bottles_enter_gv_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "DA00")
    ...
    def _bottles_learned_gv_moves(self):
        ...
        intro_cutscene_text = Speech_File(self._file_dir, "B2C8")
...
#         bottles_intro_text._replace_line("4c495354454e20555021", "WELCOME TO THE BANJO-KAZOOIE RANDOMIZER V2! PRESS L R B TO SKIP THIS TEXT!")
        bottles_intro_text = Speech_File(self._file_dir, "CE30")
    ...
    def _modify_bottles_unskippable_text(self, final_note_option, final_note_score, final_puzzle_option, final_puzzle_score):
        ...
        bottles_unskippable_text = Speech_File(self._file_dir, "CF90")
    ...
    def _shorten_bottles_secret_game_text(self):
        ...
        secret_game_text = Speech_File(self._file_dir, "CF98")
    ...
    def _furnace_fun_questions_main(self, empty=True):
        ...
        for pointer_index_str in furnace_fun_json:
            furnace_fun_text = Speech_File(self._file_dir, pointer_index_str[2:])
